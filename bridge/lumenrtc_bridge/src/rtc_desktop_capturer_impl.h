...
#ifndef LUMENRTC_BRIDGE_RTC_DESKTOP_CAPTURER_IMPL_HXX
#define LUMENRTC_BRIDGE_RTC_DESKTOP_CAPTURER_IMPL_HXX
...
#endif  // LUMENRTC_BRIDGE_RTC_DESKTOP_CAPTURER_IMPL_HXX
