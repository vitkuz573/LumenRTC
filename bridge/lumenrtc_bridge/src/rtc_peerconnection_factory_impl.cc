...
template <typename Factory>
webrtc::scoped_refptr<webrtc::AudioSourceInterface> CreateAudioSourceDirect(
    Factory* factory, const webrtc::AudioOptions& options) {
...
RTCPeerConnectionFactoryImpl::RTCPeerConnectionFactoryImpl() = default;
...
bool RTCPeerConnectionFactoryImpl::Initialize() {
  ...
  worker_thread_->SetName("lumenrtc_worker", nullptr);
  ...
  signaling_thread_->SetName("lumenrtc_signaling", nullptr);
  ...
  network_thread_->SetName("lumenrtc_network", nullptr);
...
scoped_refptr<RTCAudioSource> RTCPeerConnectionFactoryImpl::CreateAudioSource(
  ...
  if (source_type == RTCAudioSource::SourceType::kCustom) {
    webrtc::scoped_refptr<lumenrtc_bridge::LocalAudioSource> custom_source =
        lumenrtc_bridge::LocalAudioSource::Create(&rtc_options);
  ...
  webrtc::scoped_refptr<webrtc::AudioSourceInterface> default_source =
      CreateAudioSourceDirect(rtc_peerconnection_factory_.get(), rtc_options);
