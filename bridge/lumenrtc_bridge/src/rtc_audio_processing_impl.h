#ifndef LUMENRTC_BRIDGE_RTC_AUDIO_PROCESSING_IMPL_HXX
#define LUMENRTC_BRIDGE_RTC_AUDIO_PROCESSING_IMPL_HXX
...
#endif  // LUMENRTC_BRIDGE_RTC_AUDIO_PROCESSING_IMPL_HXX
