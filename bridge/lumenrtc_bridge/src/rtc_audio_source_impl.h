#ifndef LUMENRTC_BRIDGE_AUDIO_SOURCE_IMPL_HXX
#define LUMENRTC_BRIDGE_AUDIO_SOURCE_IMPL_HXX
...
class RTCAudioSourceImpl : public RTCAudioSource {
 public:
  RTCAudioSourceImpl(
      ...
      webrtc::scoped_refptr<lumenrtc_bridge::LocalAudioSource> custom_audio_source,
 ...
 private:
  ...
  webrtc::scoped_refptr<lumenrtc_bridge::LocalAudioSource> custom_audio_source_;
  SourceType source_type_;
};

}  // namespace lumenrtc_bridge

#endif  // LUMENRTC_BRIDGE_AUDIO_SOURCE_IMPL_HXX
