...
#ifndef LUMENRTC_BRIDGE_RTC_DESKTOP_MEDIA_LIST_IMPL_HXX
#define LUMENRTC_BRIDGE_RTC_DESKTOP_MEDIA_LIST_IMPL_HXX
...
#endif  // LUMENRTC_BRIDGE_RTC_DESKTOP_MEDIA_LIST_IMPL_HXX
