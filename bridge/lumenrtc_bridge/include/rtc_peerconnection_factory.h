#ifndef LUMENRTC_BRIDGE_RTC_PEERCONNECTION_FACTORY_HXX
#define LUMENRTC_BRIDGE_RTC_PEERCONNECTION_FACTORY_HXX
...
#endif  // LUMENRTC_BRIDGE_RTC_PEERCONNECTION_FACTORY_HXX
