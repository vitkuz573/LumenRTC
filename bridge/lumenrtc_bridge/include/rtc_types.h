#ifndef LUMENRTC_BRIDGE_RTC_TYPES_HXX
#define LUMENRTC_BRIDGE_RTC_TYPES_HXX

#ifdef LUMENRTC_BRIDGE_API_EXPORTS
#define LUMENRTC_BRIDGE_API __declspec(dllexport)
#elif defined(LUMENRTC_BRIDGE_API_DLL)
#define LUMENRTC_BRIDGE_API __declspec(dllimport)
#elif !defined(WIN32)
#define LUMENRTC_BRIDGE_API __attribute__((visibility("default")))
#else
#define LUMENRTC_BRIDGE_API
#endif
...
#endif  // LUMENRTC_BRIDGE_RTC_TYPES_HXX
