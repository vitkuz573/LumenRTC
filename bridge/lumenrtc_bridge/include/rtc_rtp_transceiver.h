#ifndef LUMENRTC_BRIDGE_RTC_RTP_TRANSCEIVER_HXX
#define LUMENRTC_BRIDGE_RTC_RTP_TRANSCEIVER_HXX
...
class RTCRtpTransceiverInit : public RefCountInterface {
 public:
  LUMENRTC_BRIDGE_API static scoped_refptr<RTCRtpTransceiverInit> Create(
