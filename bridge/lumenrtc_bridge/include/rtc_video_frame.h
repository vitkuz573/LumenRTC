#ifndef LUMENRTC_BRIDGE_RTC_VIDEO_FRAME_HXX
#define LUMENRTC_BRIDGE_RTC_VIDEO_FRAME_HXX
...
class RTCVideoFrame : public RefCountInterface {
 ...
 public:
  LUMENRTC_BRIDGE_API static scoped_refptr<RTCVideoFrame> Create(
...
#endif  // LUMENRTC_BRIDGE_RTC_VIDEO_FRAME_HXX
