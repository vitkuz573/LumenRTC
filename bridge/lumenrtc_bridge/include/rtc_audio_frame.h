#ifndef LUMENRTC_BRIDGE_RTC_AUDIO_FRAME_HXX
#define LUMENRTC_BRIDGE_RTC_AUDIO_FRAME_HXX
...
class AudioFrame : public RefCountInterface {
 public:
   ...
   */
  LUMENRTC_BRIDGE_API static AudioFrame* Create();
   ...
   * @return AudioFrame*: a pointer to the newly created AudioFrame.
   */
  LUMENRTC_BRIDGE_API static AudioFrame* Create(int id, uint32_t timestamp,
                                           const int16_t* data,
...
#endif  // LUMENRTC_BRIDGE_RTC_AUDIO_FRAME_HXX
